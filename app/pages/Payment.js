        ...
        <>
            <View style={{ flex: 1, backgroundColor: "#fff", padding: 20 }}>
                ...
                <View style={{ flexDirection: "row", justifyContent: "center", marginBottom: 20 }}>
                    <TouchableOpacity> <Image source={require('../../assets/images/jazz.png')} style={{ width: 120, height: 40, resizeMode: "contain" }} /></TouchableOpacity>
                    <TouchableOpacity> <Image source={require('../../assets/images/easy.png')} style={{ width: 120, height: 40, resizeMode: "contain" }} /></TouchableOpacity>
                </View>
                ...
                {/* Sender Account */}
                <TextInput placeholder="Sender Account Number" value={senderAcc} onChangeText={setSenderAcc} keyboardType="numeric"
                    style={{ borderWidth: 1, borderColor: "#ccc", borderRadius: 8, padding: 12, marginBottom: 15 }} />

                {/* Receiver Account */}
                <TextInput placeholder="Receiver Account Number" value={receiverAcc} onChangeText={setReceiverAcc} keyboardType="numeric"
                    style={{ borderWidth: 1, borderColor: "#ccc", borderRadius: 8, padding: 12, marginBottom: 15 }} />
                ...
                {/* Confirm Button */}
                <TouchableOpacity onPress={goToSuccess}  style={{ backgroundColor: "#47D6FF", padding: 15, borderRadius: 8, alignItems: "center" }}>
