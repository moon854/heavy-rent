    ...
    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '80%', marginTop: 30 }}>
        <View style={{ width: 150, height: 50, display: 'flex', flexDirection: 'row' }} >
          ...
          <View>
            <TextInput style={{ width: 100, height: 50, alignSelf: 'center', borderRadius: 10, marginTop: 0, paddingLeft: 10 }} placeholder="Search" />
          </View>
        </View>
        <View style={{ width: 120, height: 60, }} >
          <View>
            <Image source={require('../../assets/images/dp.png.jpg')} style={{ width: 50, height: 50, borderRadius: 50, marginLeft: 60 }} />
          </View>
        </View>
      ...
      <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', width: '80%', }}>
        <View>
