    ...
    <>
      ...
      <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly' }}>
        <View style={{ outlineColor: 'black', outlineWidth: 1, borderRadius: 8, width: 140, height: 50 }}>
          <View> <Text style={{ fontSize: 17, marginLeft: 10 }}>Power</Text></View>
          <View> <Text style={{ fontSize: 10, marginLeft: 0 }}>110 ps @ 2,800 rpm</Text></View>

        </View>
        <View style={{ outlineColor: 'black', outlineWidth: 1, borderRadius: 8, width: 140, height: 50 }}>
          <View> <Text style={{ fontSize: 17, marginLeft: 10 }}>Machine</Text></View>
          <View> <Text style={{ fontSize: 10, marginLeft: 20 }}>4,009 cc</Text></View>

        </View>
        <View style={{ outlineColor: 'black', outlineWidth: 1, borderRadius: 8, width: 140, height: 50 }}>
          <View> <Text style={{ fontSize: 17, marginLeft: 10 }}>Torque</Text></View>
      ...
      <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly' }}>
        <View style={{ outlineColor: 'gray', outlineWidth: 1, borderRadius: 8, width: 170, height: 50, marginTop: 20 }}><Text style={{ fontSize: 12, marginLeft: 10 }}>The rental price includes PPh and VAT</Text></View>
        <View style={{ outlineColor: 'gray', outlineWidth: 1, borderRadius: 8, width: 170, height: 50, marginTop: 20 }}><Text style={{ fontSize: 12, marginLeft: 10 }}>The rental price includes PPh and VAT</Text></View>
